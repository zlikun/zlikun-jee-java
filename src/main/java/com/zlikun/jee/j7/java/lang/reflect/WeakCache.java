...
final class WeakCache<K, P, V> {
    ...
    private final ConcurrentMap<Object, ConcurrentMap<Object, WeakCache.Supplier<V>>> map
            = new ConcurrentHashMap<>();
    private final ConcurrentMap<WeakCache.Supplier<V>, Boolean> reverseMap
            = new ConcurrentHashMap<>();
    private final WeakCache.BiFunction<K, P, ?> subKeyFactory;
    private final WeakCache.BiFunction<K, P, V> valueFactory;
     ...
     */
    public WeakCache(WeakCache.BiFunction<K, P, ?> subKeyFactory,
                     WeakCache.BiFunction<K, P, V> valueFactory) {
    ...
    public V get(K key, P parameter) {
        ...
        ConcurrentMap<Object, WeakCache.Supplier<V>> valuesMap = map.get(cacheKey);
        if (valuesMap == null) {
            ConcurrentMap<Object, WeakCache.Supplier<V>> oldValuesMap
        ...
        WeakCache.Supplier<V> supplier = valuesMap.get(subKey);
    ...
    /**
     * A factory {@link WeakCache.Supplier} that implements the lazy synchronized
     * construction of the value and installment of it into the cache.
     */
    private final class Factory implements WeakCache.Supplier<V> {
     ...
     */
    private interface Value<V> extends WeakCache.Supplier<V> {}
